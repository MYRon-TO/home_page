  // <script src="//cdn.jsdelivr.net/npm/matter-js@0.19.0"></script>
 // "use strict";
 ...
 function bootstrap() {
   function e() {
     let e = 1e4,
       ...
       r = Matter.Bodies.rectangle(window.innerWidth / 2 + window.scrollX,
       ...
       n = Matter.Bodies.rectangle(-e / 2 + window.scrollX,
       ...
       i = Matter.Bodies.rectangle(window.innerWidth + e / 2 + window.scrollX,
         window.innerHeight / 2 + window.scrollY,
         e,
         window.innerHeight + 2 * e,
         {
   ...
   function I(e) {
     let t = Math.min(e - q, 100);
     q = e;
     let r = window.scrollX, n = window.scrollY;
     if (k + 100 < e) {
       W && Matter.Composite.translate(W, {x: r - V, y: n - N}), V = r, N = n;
       let i = window.screenX - R, o = window.screenY - T, a = !0, l = !1, d = undefined;
       try {
         for (let s, w = engine.world.bodies[Symbol.iterator]();
           !(a = (s = w.next()).done); a = !0) {
           (m = s.value) !==
             W && Matter.Body.translate(
               m,
               {x: -i, y: -o}
             )
         }
     ...
     let c = Matter.Composite.allBodies(engine.world), u = !0, f = !1, y = undefined;
     try {
       for (let v, g = c[Symbol.iterator]();
         !(u = (v = g.next()).done);
         u = !0) {
         let m, p = (m = v.value).id, h = P.get(p);
         if (h) {
           let M = _slicedToArray(h, 3), x = M[0], b = M[1], S = M[2];
           if (x && x.offsetParent) {
             let B = x.offsetParent.getBoundingClientRect(),
               C = B.top, X = B.left + x.offsetLeft + b / 2,
               Y = C + x.offsetTop + S / 2,
               A = m.position.x - r,
               E = m.position.y - n,
               L = m.angle;
   ...
   requestAnimationFrame(I),
     document.body.addEventListener(
       "click",
       function (e) {
         let t = findNearestBlock(e.target);
         if (t.classList.contains("meow-floating"))
           return !0;
         ...
         if (600 < a)
           return !0;
         let l = window.scrollX + i,
           d = window.scrollY + n,
           s = Matter.Bodies.rectangle(l + o / 2,
             d + a / 2,
             o,
             a,
             {restitution: .8}
         ...
         let y =
           t.querySelectorAll("a[data-toggle=popover]"),
           v = !0,
           g = !1,
           m = undefined;
         try {
           for (let p, h = y[Symbol.iterator]();
             !(v = (p = h.next()).done);
             v = !0) {
         ...
         let M = t.querySelectorAll(".popover"),
           x = !0,
           b = !1,
           S = undefined;
         try {
           for (
             let B, C = M[Symbol.iterator]();
             !(x = (B = C.next()).done);
             x = !0
           ) {
             B.value.remove()
 ...
 let _slicedToArray = function () {
   function r(e, t) {
     let r = [], n = !0, i = !1, o = undefined;
     try {
       for (let a, l = e[Symbol.iterator]();
   ...
   (), Matter = window.Matter, engine = null;
 window.addEventListener("devicemotion", function (e) {
   if (engine) {
     if (e.accelerationIncludingGravity) {
       let t = e.accelerationIncludingGravity.x, r = e.accelerationIncludingGravity.y;
       if (null === t || null === r)
         return;
       let n = Matter.Vector.create(2e-4 * t, 2e-4 * -r),
     ...
     if (e.rotationRate) {
       ...
       try {
         for (
           let u, f = engine.world.bodies[Symbol.iterator]();
           !(s = (u = f.next()).done);
           s = !0
         ) {
           let y = u.value;
